...
class Icp3d {
   public:
    ...
    bool ComputeResidualAndJacobiansP2P(const SE3& pose, Mat18d& HTVH, Vec18d& HTVr);
    bool ComputeResidualAndJacobiansP2P2(const SE3& pose, Mat18d& HTVH, Vec18d& HTVr);

    bool ComputeResidualAndJacobiansP2Plane(const SE3& pose, Mat18d& HTVH, Vec18d& HTVr);
    bool ComputeResidualAndJacobiansP2Plane2(const SE3& pose, Mat18d& HTVH, Vec18d& HTVr);

    bool ComputeResidualAndJacobiansP2L(const SE3& pose, Mat18d& HTVH, Vec18d& HTVr);
    bool ComputeResidualAndJacobiansP2L2(const SE3& pose, Mat18d& HTVH, Vec18d& HTVr);
